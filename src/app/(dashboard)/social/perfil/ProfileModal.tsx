...
export default function ProfileModal({ isOpen, onClose }: ProfileModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-slate-900/60 backdrop-blur-md p-4 sm:p-8">
      <div className="relative w-full h-full max-w-6xl bg-orion-surface dark:bg-slate-950 rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden border border-orion-border dark:border-orion-dark-border animate-in fade-in zoom-in duration-300">
