...
import type { AdminUser, CreateAdminUserPayload, UserRole } from "../types";
...
export default function AdminPanel() {
  ...
  const handleToggleRole = async (target: AdminUser) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "No se pudo actualizar el rol del usuario");
    }
  };
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Lista de usuarios, bloqueo/activación, roles y creación de cuentas.
            </p>
          </div>
