...
export default function QuickNoteModal({ open, title, initialValue, submitting = false, error = null, onClose, onSave }: QuickNoteModalProps) {
      ...
      <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-orion-border bg-white shadow-2xl dark:border-orion-dark-border dark:bg-slate-900">
        ...
        <div className="space-y-3 p-4">
          <textarea
            ...
            className="min-h-64 w-full resize-none rounded-2xl border border-black/10 px-3 py-3 text-sm leading-relaxed text-slate-800 outline-none transition-colors focus:ring-2 focus:ring-orion-primary/30"
